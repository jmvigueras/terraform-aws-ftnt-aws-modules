...
| <a name="input_fgt_subnet_tags"></a> [fgt\_subnet\_tags](#input\_fgt\_subnet\_tags) | Subnet tags map assigned to each subnet, must much with variable subnet\_tags | `map(string)` | <pre>{<br/>  "port1.public": "untrust",<br/>  "port2.private": "trust",<br/>  "port3.mgmt": "mgmt"<br/>}</pre> | no |
...
| <a name="output_fgt_ips_map"></a> [fgt\_ips\_map](#output\_fgt\_ips\_map) | Map of FortiGate network interfaces IPs |
