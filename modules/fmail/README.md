...
| [aws_ami_ids.fmail_amis_byol](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ami_ids) | data source |
| [aws_ami_ids.fmail_amis_payg](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ami_ids) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_admin_username"></a> [admin\_username](#input\_admin\_username) | FMAIL username used for API key | `string` | `"admin"` | no |
...
| <a name="input_fmail_version"></a> [fmail\_version](#input\_fmail\_version) | FortiMail version | `string` | `"7.4.2"` | no |
| <a name="input_iam_profile"></a> [iam\_profile](#input\_iam\_profile) | IAM profile to assing to the instance | `string` | `null` | no |
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | FortiMail instance type | `string` | `"m5.large"` | no |
| <a name="input_keypair"></a> [keypair](#input\_keypair) | AWS key pair name | `string` | `null` | no |
| <a name="input_license_file"></a> [license\_file](#input\_license\_file) | License file path | `string` | `"./licenses/licenseFMAIL.lic"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_ami_names"></a> [ami\_names](#output\_ami\_names) | Debbuging |
| <a name="output_details"></a> [details](#output\_details) | FortiMail details |
| <a name="output_id"></a> [id](#output\_id) | FortiMail instance ID |
| <a name="output_private_ip"></a> [private\_ip](#output\_private\_ip) | FortiMail private IP |
| <a name="output_public_ip"></a> [public\_ip](#output\_public\_ip) | FortiMail public IP |
<!-- END_TF_DOCS -->
