...
output "subnet_cidrs_ipv6" {
  description = "IPv6 CIDRs of the subnets"
  value       = local.o_subnet_cidrs_ipv6
}

output "subnet_public_cidrs_ipv6" {
  description = "IPv6 CIDRs of public subnets"
  value       = local.o_subnet_public_cidrs_ipv6
}

output "subnet_private_cidrs_ipv6" {
  description = "IPv6 CIDRs of private subnets"
  value       = local.o_subnet_private_cidrs_ipv6
}