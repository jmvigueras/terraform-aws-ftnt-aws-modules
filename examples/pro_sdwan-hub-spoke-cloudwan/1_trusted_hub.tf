...
# Create FGT NIs
module "eu_hub_nis" {
  source = "../../modules/fgt_ni_sg?ref=v0.0.1"
...
module "eu_hub_config" {
  ...
  source   = "../../modules/fgt_config?ref=v0.0.1"
...
module "eu_hub_vpc_routes" {
  source = "../../modules/vpc_routes?ref=v0.0.1"
