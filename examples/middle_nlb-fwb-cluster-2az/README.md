...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_fwb"></a> [fwb](#module\_fwb) | ../../modules/fwb | n/a |
| <a name="module_fwb_vpc"></a> [fwb\_vpc](#module\_fwb\_vpc) | ../../modules/vpc | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_fwb_ids"></a> [fwb\_ids](#output\_fwb\_ids) | ----------------------------------------------------------------------------------------------------- Outputs ----------------------------------------------------------------------------------------------------- |
| <a name="output_fwb_private_ips"></a> [fwb\_private\_ips](#output\_fwb\_private\_ips) | n/a |
| <a name="output_fwb_public_ips"></a> [fwb\_public\_ips](#output\_fwb\_public\_ips) | n/a |
