...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_fad"></a> [fad](#module\_fad) | ../../modules/fad | n/a |
| <a name="module_fad_vpc"></a> [fad\_vpc](#module\_fad\_vpc) | ../../modules/vpc | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_fad_ids"></a> [fad\_ids](#output\_fad\_ids) | ----------------------------------------------------------------------------------------------------- Outputs ----------------------------------------------------------------------------------------------------- |
| <a name="output_fad_private_ips"></a> [fad\_private\_ips](#output\_fad\_private\_ips) | n/a |
| <a name="output_fad_public_ips"></a> [fad\_public\_ips](#output\_fad\_public\_ips) | n/a |
